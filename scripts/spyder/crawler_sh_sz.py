...
#               
  ...
  #  print("上海市场 -------------------------------------------------------------“)
    ...
    print(date, "科创板",result_gp[3]['trdAmt1'])
   # if target == "jj":
      #for jj handle      
   # print(result_jj)
   ...
   # print("zq result set" , result_zq)
    ...
    row[12] = result_zq[7]['txAmout']
    row[13] = result_zq[3]['txAmout']
    row[14] = result_zq[2]['txAmout']
    row[15] = result_zq[1]['txAmout']
    row[16] = result_zq[5]['txAmout']
    row[17] = result_zq[4]['txAmout']
    row[18] = result_zq[6]['txAmout']
