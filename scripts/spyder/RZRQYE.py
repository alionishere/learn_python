...
&p=' + str(
    page) + '&ps=50&js=var%20TYhRIYCc={pages:(tp),data:%20(x)}&type=RZRQ_HSTOTAL_NJ&filter=(market=%27SH%27)&mk_time=1&rt=51584747'

url_sz = 'http://dcfm.eastmoney.com//EM_MutiSvcExpandInterface/api/js/get?token=70f12f2f4f091e459a279469fe49eca5&st=tdate&sr=-1\
&p=' + str(
    page) + '&ps=50&js=var%20oziRpEXk={pages:(tp),data:%20(x)}&type=RZRQ_HSTOTAL_NJ&filter=(market=%27SZ%27)&mk_time=1&rt=51584553'
