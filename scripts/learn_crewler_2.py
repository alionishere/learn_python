    ...
    while not q.empty():
        try:
            ...
            for x in range(100):
                ...
                managerurl = str(
                    'http://gs.amac.org.cn/amac-infodisc/res/pof' + str(dicts['managerUrl']).replace('..', ''))
                ...
                yzzt = str(ListTemp(html.xpath('/html/body/div/div[2]/div/table/tbody/tr[11]/td[2]'))).strip().replace(
                    '\'', '\'\'')
                jjxxzhgxsj = str(
                    ListTemp(html.xpath('/html/body/div/div[2]/div/table/tbody/tr[12]/td[2]'))).strip().replace('-', '')
                jjxhtbts = str(
                    ListTemp(html.xpath('/html/body/div/div[2]/div/table/tbody/tr[13]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                ...
                jgcxxx = str(
                    Gettxt(ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[1]/td[2]')))).strip().replace(
                    '\'', '\'\'')
                jjglrch = str(ListTemp(html2.xpath('//*[@id="complaint2"]'))).replace('&nbsp', '').strip().replace('\'',
                                                                                                                   '\'\'')
                jjglrzh = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[4]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                djbh = str(ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[5]/td[2]'))).strip().replace(
                    '\'', '\'\'')
                zzjgdm = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[6]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                ...
                qyxz = str(ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[11]/td[2]'))).strip().replace(
                    '\'', '\'\'')
                zczbsjbl = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[11]/td[4]'))).strip().replace('\'',
                                                                                                                 '\'\'')
                gljjzylb = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[12]/td[2]'))).strip().replace('\'',
                                                                                                                 '\'\'')
                sqqtywlx = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[12]/td[4]'))).strip().replace('\'',
                                                                                                                 '\'\'')
                ...
                jgwz = str(ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[13]/td[4]'))).strip().replace(
                    '\'', '\'\'')
                sfwhy = str(
                    ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[15]/td[2]'))).strip().replace('\'',
                                                                                                                 '\'\'')
                if sfwhy == '是':
                    dqhylx = str(
                        ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[16]/td[2]'))).strip().replace(
                        '\'', '\'\'')
                    rhsj = str(
                        ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[16]/td[4]'))).strip().replace(
                        '-', '')
                    flyjszt = str(
                        ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[18]/td[2]'))).strip().replace(
                        '\'', '\'\'')
                    if flyjszt == '办结':
                        lsswsmc = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[19]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        lsxm = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[20]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        fddbr = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[22]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        sfycyzg = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[23]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        zgqdfs = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[23]/td[4]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        gzll = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[24]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        ggqk = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[25]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        jgxxzhgxsj = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[30]/td[2]'))).strip().replace('-', '')
                        ...
                        fddbr = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[20]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        sfycyzg = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[21]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        zgqdfs = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[21]/td[4]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        gzll = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[22]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        ggqk = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[23]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        jgxxzhgxsj = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[28]/td[2]'))).strip().replace('-', '')
                        tbtsxx = str(ListTemp(html2.xpath('//*[@id="specialInfos"]'))).strip()
                else:
                    dqhylx = ''
                    rhsj = ''
                    flyjszt = str(
                        ListTemp(html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[17]/td[2]'))).strip().replace(
                        '\'', '\'\'')
                    if flyjszt == '办结':
                        lsswsmc = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[18]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        lsxm = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[19]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        ...
                        sfycyzg = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[22]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        zgqdfs = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[22]/td[4]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        gzll = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[23]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        ggqk = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[24]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        jgxxzhgxsj = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[29]/td[2]'))).strip().replace('-', '')
                        tbtsxx = str(ListTemp(html2.xpath('//*[@id="specialInfos"]'))).strip().replace('\'', '\'\'')
                    else:
                        lsswsmc = ''
                        lsxm = ''
                        ...
                        sfycyzg = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[20]/td[2]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        zgqdfs = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[20]/td[4]'))).strip().replace('\'',
                                                                                                                '\'\'')
                        gzll = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[21]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        ggqk = str(Gettxt(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[22]/td[2]')))).strip().replace('\'',
                                                                                                                 '\'\'')
                        jgxxzhgxsj = str(ListTemp(
                            html2.xpath('/html/body/div/div[2]/div/table/tbody/tr[27]/td[2]'))).strip().replace('-', '')
                        tbtsxx = str(ListTemp(html2.xpath('//*[@id="specialInfos"]'))).strip().replace('\'', '\'\'')
                sql3 = "declare \n" \
                       "   gzll_v clob; \n" \
                       "   ggqk_v clob; \n" \
